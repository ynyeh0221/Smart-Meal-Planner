...
<div id="container">
<h1 style="text-align:center;" class="bgClip">Weekly Nutrition Comparison</h1>
</div>
<br>
<br>
<div align="center">
<select class="selectday" onChange="location = this.options[this.selectedIndex].value;">
...
<ul>
<li >The length of each <b><font color="#1f77b4">blue bar</font></b> indicates <b>N<sub>breakfast, selected nutrition</sub></b>,</li>
<li >The length of each <b><font color="#ff7f0e">orange bar</font></b> indicates <b>N<sub>lunch, selected nutrition</sub></b>,</li>
<li >The length of each <b><font color="#2ca02c">green bar</font></b> indicates <b>N<sub>dinner, selected nutrition</sub></b>.</li>
</ul>
<br>
<h3>Operation</h3>
<ul>
<li ><b>Select different nutritions</b> by using the select menu.</li>
<li ><b>Show the recipe name/amount of nutrition</b> by moving mouse over a bar.</li>
<li ><b>Show the grouped/stacked bar chart</b> by clicking the radio buttons.</li>
</ul>
</div>
<br>
...
function get_nutrition(sel) {
  ...
  .offset([-10, 0])
  .html(function(d,i,j) {
		return week_name[i][j].replace(myRegExp2, replaceText2).replace(myRegExp3, replaceText3)+": "+weekmeal[i][j] + " (" + unit+")";
  })
